...
# machines_run_var,results_power_var,results_input_variables_var,results_state_varaibes_var,results_es_var = \
...
results_state_var,results_input_variables_var,results_power_var,results_battery_var =\
                    reduced_sme.sme_opt_mpc(K=10,N_sim=N_sim,L1=1000,L2=0,c_buy=0.30,c_sell=0.3,market_id="M-01",
                   participation_mechanism="Day_ahead",cas_opt=True,pcs_opt=True,phs_opt=False,hvac_opt=False,chp_opt=False)
